...
/**
 * Generic class to generate barrels for loot in small domes
 *
 * @author IPat
 */
public abstract class SmallDomeWithBarrelGenerator extends SmallDomeGenerator {
    public SmallDomeWithBarrelGenerator(SmallDomePalette palette, double brokenRate, World world, int originX, int originZ, NoiseGenerator noiseGenerator, double treasureChance) {
        super(palette, brokenRate, world, originX, originZ, noiseGenerator, treasureChance);
    }

    public SmallDomeWithBarrelGenerator(SmallDomePalette palette, double brokenRate, World world, int originX, int originY, int originZ, NoiseGenerator noiseGenerator, double treasureChance) {
